...
const CollegeEvents = () => {
  ...
  const techEvents = [
    ...
    },
    {
      ...
      videoUrl2: "/poster/video2.mp4",
      registrationLink:
        "https://docs.google.com/forms/d/e/1FAIpQLScr0g_0jamSuNh15AdBcO92-9Sv0VZKeK1u9_us-X7QMywzUQ/viewform?usp=dialog",
      rulebookLink:
    ...
    },
    {
      ...
      videoUrl2: "/poster/video2.mp4",
      registrationLink:
        "https://docs.google.com/forms/d/e/1FAIpQLScpYrea_RNf5lalNmDDdIt_pDq1L-OgHoRMQWsoO1A38q7RBA/viewform?usp=header",
      rulebookLink:
    ...
    },
    {
      ...
      videoUrl2: "/poster/video2.mp4",
      registrationLink:
        "https://docs.google.com/forms/d/e/1FAIpQLSeO9thlXfTxum5lmT6A9m7bjfz8ou1fnEOtzzvDxcp-mTr21Q/viewform",
      rulebookLink:
  ...
  const nonTechEvents = [
    {
      ...
      videoUrl2: "/poster/video2.mp4",
      registrationLink:
        "https://docs.google.com/forms/d/e/1FAIpQLSdguXk-7MzzQwhBLmjTGmFoBJCn6VpeENu1Eaf4nWSKRXGn_Q/viewform?usp=header",
      rulebookLink:
  ...
  useEffect(() => {
    ...
    return () => {
      events.forEach((_, index) => {
        const video1 = document.getElementById(`video${index + 1}-1`);
        if (video1)
          video1.removeEventListener("ended", videoEndHandlers[index]);
      });
      if (firstVideo) {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center min-h-screen bg-black position-relative btn"
      style={{
        backgroundImage: `url(${bg})`,
      }}
    >
      <section className="relative  py-16 md:py-24 ">
        <div className="absolute inset-0 z-0 object-center overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-black via-red-900/20 to-black opacity-60 "></div>
          <img
            src="https://images.unsplash.com/photo-1537420327992-d6e192287183?q=80&w=1920&h=800"
            alt="Events background with red cosmic dust"
            fill="true"
            className="object-center h-[55vh] lg:h-[59vh]"
            priority="true"
          />
        </div>
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-[800px] mx-auto mb-8">
            Join us for mind-expanding experiences across the multiverse. From
            scientific explorations to Marvel-inspired gatherings.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <button
                className={`rounded-lg font-bold text-2xl ${activeTab==="tech"?"bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900":"border-red-500 bg-white text-red-400 hover:bg-red-950/50"}`}
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <button
                variant="outline"
                className={`rounded-lg text-xl bg-white ${activeTab==="non-tech"?"bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900":"border-red-500 text-red-400 hover:bg-red-950/50"}`}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 max-w-7xl mt-10 mx-auto p-2">
        {renderEventCards()}
      </div>
          ...
          >
            <div className="modal-details">
              <h2 id="modalTitle" className="text-3xl font-bold">
                {
                  (activeTab === "tech" ? techEvents : nonTechEvents)[
                    activeModal
                  ].title
                }
              </h2>
